...
export default function Index(props) {
  ...
  const renderChildren = (props) => {
    return React.Children.map(props.children, (child) => {
      if (props.childNames.includes(child.type))
      ...
      >
        <defs>
          ...
          <image
            ...
            width="23"
            height="23"
            xlinkHref={require("@/assets/images/center/image-1.png")}
          />
          <image
            id="image-2"
            width="15"
            height="15"
            xlinkHref={require("@/assets/images/center/image-2.png")}
          />
        </defs>
        <g id="dongxiao1">
          <g id="icon">
            ...
            />
            <image
              className="icon_home_foshan"
              x="582"
              y="17"
              width="103"
              height="103"
              xlinkHref={require("@/assets/images/center/home.png")}
            />
          </g>
          <g id="circle">
            <path
            ...
            <image
              ...
              width="72"
              height="92"
              xlinkHref={require("@/assets/images/center/light_0_3.png")}
            />
            <image
              id="light_o_2"
              x="141"
              ...
              width="99"
              height="137"
              xlinkHref={require("@/assets/images/center/light_0_2.png")}
            />
            <image
              id="light_o_1"
              x="436"
              ...
              width="99"
              height="66"
              xlinkHref={require("@/assets/images/center/light_0_1.png")}
            />
          </g>
          <image
            id="center-houes"
            ...
            width="539"
            height="419"
            xlinkHref={require("@/assets/images/center/house.png")}
          />
          <g id="right">
            <g id="组_380" data-name="组 380">
              ...
              <g id="dots_b">
                ...
                <image
                  ...
                  width="22"
                  height="23"
                  xlinkHref={require("@/assets/images/center/dots28.png")}
                />
                <circle
                  id="dots27"
                  className="cls-40"
              ...
              <g id="dots_o">
                ...
                <circle
                  ...
                  r="2.781"
                />
                <use id="dots12" x="516" y="118" xlinkHref="#image" />
                <use id="dots11" x="505" y="304" xlinkHref="#image" />
                <use id="dots10" x="572" y="353" xlinkHref="#image" />
                <use id="dots09" x="486" y="555" xlinkHref="#image" />
                <use id="dots08" x="479" y="465" xlinkHref="#image" />
                <use id="dots07" x="499" y="158" xlinkHref="#image-2" />
                <use id="dots06" x="483" y="221" xlinkHref="#image-2" />
                <use id="dots05" x="470" y="239" xlinkHref="#image-2" />
                <use id="dots04" x="632" y="383" xlinkHref="#image-2" />
                <use id="dots03" x="564" y="346" xlinkHref="#image-2" />
                <use id="dots02" x="455" y="415" xlinkHref="#image-2" />
                <use id="dots01" x="482" y="455" xlinkHref="#image-2" />
              </g>
            </g>
          </g>
          <g id="text">
